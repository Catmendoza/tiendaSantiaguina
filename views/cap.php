...
<body>
  ...
  <section class="site-section">
    <div class="container">
      <div class="row mb-4">
        <div class="col-md-6">
          <h2 class="mb-4">Categoria: Gorras</h2>
        </div>
      </div>
          ...
          <div class="row mb-5 mt-5">
            ...
            <div class="col-md-12">
              ...
              <div class="post-entry-horzontal">
                <a>
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/gorra1.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                    ...
                    <h2>Gorras Santiaguinas rojas</h2>
                    <h2>Cantidad: 15 gorras</h2>
                    <h3>Precio: $25.000</h3>
              ...
              <div class="post-entry-horzontal">
                <a>
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/gorra2.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Gorras</span>
                    ...
                    <h2>Gorras Santiaguinas negra</h2>
                    <h2>Cantidad: 20 gorras</h2>
                    <h3>Precio: $25.000</h3>
                    <h2><a href="#" class="btn btn-primary btn-sm">Comprar</a></h2>
                  </span>
                </a>
              ...
              <div class="post-entry-horzontal">
                <a>
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/gorra3.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Gorras</span>
                    ...
                    <h2>Gorras Santiaguinas azul</h2>
                    <h2>Cantidad: 10 gorras</h2>
                    <h3>Precio: $25.000</h3>
                    <h2><a href="#" class="btn btn-primary btn-sm">Comprar</a></h2>
                  </span>
                </a>
