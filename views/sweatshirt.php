...
<body>
  ...
  <section class="site-section">
    <div class="container">
      <div class="row mb-4">
        <div class="col-md-6">
          <h2 class="mb-4">Categoria: Sudaderas</h2>
        </div>
      </div>
          ...
          <div class="row mb-5 mt-5">
            ...
            <div class="col-md-12">
              ...
              <div class="post-entry-horzontal">
                <a>
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/sudadera1.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Sudadera</span>
                      <span class="mr-2">
                        <script>
                    ...
                    <h2>Sudadera Santiaguinas blanca</h2>
                    <h2>Cantidad: 10</h2>
                    <h3>Precio: $65.000</h3>
              ...
              <div class="post-entry-horzontal">
                <a>
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/sudadera2.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Sudadera</span>
                    ...
                    <h2>Sudadera Santiaguinas mostaza</h2>
                    <h2>Cantidad: 20</h2>
                    <h3>Precio: $80.000</h3>
                    <h2><a href="#" class="btn btn-primary btn-sm">Comprar</a></h2>
                  </span>
              ...
              <div class="post-entry-horzontal">
                <a>
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/sudadera3.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Sudadera</span>
                    ...
                    <h2>Sudadera Santiaguinas negra</h2>
                    <h2>Cantidad: 5</h2>
                    <h3>Precio: $60.000</h3>
                    <h2><a href="#" class="btn btn-primary btn-sm">Comprar</a></h2>
                  </span>
