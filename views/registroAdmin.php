...
<body>
    ...
    <div class="form">
        <ul class="tab-group">
            <li class="tab active">
                <h1 class="center">Registrarse como Admin</h1>
            </li>
        </ul>
        <div class="tab-content-admin">
            <div id="">

                <form action="../controllers/comprobarRegistroAdmin.php" method="post" class="form-signin">
                    <div class="top-row">
                    ...
                    <div class="field-wrap">
                        ...
                        <input type="text" required placeholder="Nombre de usuario" name="usuarioAdmin" />
                    </div>
                    <div class="field-wrap">
                    ...
                    <button type="submit" class="button button-block" name="registro">Registrarse</button>
                </form>
            </div>
        </div>
    </div>
