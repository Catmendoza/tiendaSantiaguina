...
<body>
  ...
  <section class="site-section">
    <div class="container">
      <div class="row mb-4">
        <div class="col-md-6">
          <h2 class="mb-4">Categoria: Uniformes</h2>
        </div>
      </div>
          ...
          <div class="row mb-5 mt-5">
            ...
            <div class="col-md-12">
              ...
              <div class="post-entry-horzontal">
                <a href="#">
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/enfermeria.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Enfermeria</span>
                      <span class="mr-2">
                        <script>
                    ...
                    <h2>Uniforme Santiaguino de enfermeria</h2>
                    <h2>Cantidad: 15</h2>
                    <h3>Precio: $45.000</h3>
              ...
              <div class="post-entry-horzontal">
                <a href="#">
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/uni.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Medicina</span>
                      <span class="mr-2">
                        <script>
                          document.write(fecha);
                        </script>
                    ...
                    <h2>Uniforme Santiaguino de medicina</h2>
                    <h2>Cantidad: 9</h2>
                    <h3>Precio: $45.000</h3>
                    <h2><a href="#" class="btn btn-primary btn-sm">Comprar</a></h2>
                  </span>
              ...
              <div class="post-entry-horzontal">
                <a href="#">
                  <div class="image element-animate" data-animate-effect="fadeIn">
                    <img src="../images/micro.png" onmouseover="this.width=500;this.height=400;" onmouseout="this.width=200;this.height=150;" width="200" height="150" />
                  </div>
                  <span class="text">
                    <div class="post-meta">
                      <span class="category">Microbiologia</span>
                      <span class="mr-2">
                        <script>
                          document.write(fecha);
                        </script>
                    ...
                    <h2>Uniforme Santiaguino de microbiologia</h2>
                    <h2>Cantidad: 20</h2>
                    <h3>Precio: $45.000</h3>
                    <h2><a href="#" class="btn btn-primary btn-sm">Comprar</a></h2>
                  </span>
